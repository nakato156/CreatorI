let ShortCuts = class ShortCuts {
    constructor(opt) {
        this.add = function (shortcut_combination, callback, opt = this.opt) {
            let code;
            ...
            if (!opt)
                ...
                for (var dfo in this.default_options) {
                    if (typeof opt[dfo] == 'undefined')
                        opt[dfo] = this.default_options[dfo];
                }
            }
            var ele = opt.target;
            ...
            var func = function (e) {
                ...
                for (let i = 0; keys[i], i < keys.length; i++) {
                    //Modifiers
            ...
            if (ele.addEventListener)
                ele.addEventListener(opt['type'], func);
